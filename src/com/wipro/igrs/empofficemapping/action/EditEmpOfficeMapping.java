...
public class EditEmpOfficeMapping extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (isCancelled(request)) {
			return mapping.findForward("editEmpMappingCanceld");
		}
...
//		dto.setRoleId(bean.getRoleId());
		...
		empOfficeMappingBD.updateEmpOfficeMapping(dto);
		return mapping.findForward("editEmpMappingSuccess");
	}

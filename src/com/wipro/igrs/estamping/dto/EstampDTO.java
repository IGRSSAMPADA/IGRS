...
public class EstampDTO implements Serializable {
  ...
  //  private DutyCalculationDTO objDutyCalculationDTO = new DutyCalculationDTO();
	...
	public String getApplicantTypeFlag() {
		return applicantTypeFlag;
	}

	public void setApplicantTypeFlag(String applicantTypeFlag) {
		this.applicantTypeFlag = applicantTypeFlag;
	}
	...
	public String getAdoptionTypeFlag() {
		return adoptionTypeFlag;
	}

	public void setAdoptionTypeFlag(String adoptionTypeFlag) {
		this.adoptionTypeFlag = adoptionTypeFlag;
	}
	...
	private String applicantTypeFlag;
	private String partyTypeFlag;
	private String adoptionTypeFlag;

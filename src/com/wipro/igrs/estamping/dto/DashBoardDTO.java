package com.wipro.igrs.estamping.dto;
...
public class DashBoardDTO implements Serializable {
	...
	private String courtDocTypeNameS;
	...
	public String getCourtDocTypeNameS() {
		return courtDocTypeNameS;
	}
	public void setCourtDocTypeNameS(String courtDocTypeNameS) {
		this.courtDocTypeNameS = courtDocTypeNameS;
	}
...
private String modflag;
	...
	//---added by satbir kumar----for user type
	...
	public String dutyAfterExemption;
	
	public String regFeeAfterExmemption;
	
	public String instrumentDiscription;
	...
	public ArrayList stampExemptionList=new ArrayList();
	
	public ArrayList regExemptionList=new ArrayList();
	...
	public ArrayList getStampExemptionList() {
		return stampExemptionList;
	}
	public void setStampExemptionList(ArrayList stampExemptionList) {
		this.stampExemptionList = stampExemptionList;
	}
	public ArrayList getRegExemptionList() {
		return regExemptionList;
	}
	public void setRegExemptionList(ArrayList regExemptionList) {
		this.regExemptionList = regExemptionList;
	}
	public String getDutyAfterExemption() {
		return dutyAfterExemption;
	}
	public void setDutyAfterExemption(String dutyAfterExemption) {
		this.dutyAfterExemption = dutyAfterExemption;
	}
	public String getRegFeeAfterExmemption() {
		return regFeeAfterExmemption;
	}
	public void setRegFeeAfterExmemption(String regFeeAfterExmemption) {
		this.regFeeAfterExmemption = regFeeAfterExmemption;
	}
	public String getInstrumentDiscription() {
		return instrumentDiscription;
	}
	public void setInstrumentDiscription(String instrumentDiscription) {
		this.instrumentDiscription = instrumentDiscription;
	}
	...
	public void setZeroAmountFlag(String zeroAmountFlag) {
		this.zeroAmountFlag = zeroAmountFlag;
	}
	public String getZeroAmountFlag() {
		return zeroAmountFlag;
	}
	private String adoptionFlag;
	
	private String zeroAmountFlag;
	...
	//added by saurav for e-stamp view of gov officers
	public String nameOfOfficial;
	public String designationOfOfficial;
	public String officeGovtName;
	public String nameOfOfficialN;
	public String designationOfOfficialN;
	public String officeGovtNameN;
	public String govtCountryNameN;
	public String govtStateNameN;
	public String govtDistrictNameN;
	public String govtAdressN;
	public String govtNoOfPersonN;
	public String govtCountryName;
	public String govtStateName;
	public String govtDistrictName;
	public String govtAdress;
	public String govtNoOfPerson;
	...
	public void setDesignationOfOfficial(String designationOfOfficial) {
		this.designationOfOfficial = designationOfOfficial;
	}
	public String getOfficeGovtName() {
		return officeGovtName;
	}
	public void setOfficeGovtName(String officeGovtName) {
		this.officeGovtName = officeGovtName;
	}
	public String getNameOfOfficialN() {
		return nameOfOfficialN;
	}
	public void setNameOfOfficialN(String nameOfOfficialN) {
		this.nameOfOfficialN = nameOfOfficialN;
	}
	public String getDesignationOfOfficialN() {
		return designationOfOfficialN;
	}
	public void setDesignationOfOfficialN(String designationOfOfficialN) {
		this.designationOfOfficialN = designationOfOfficialN;
	}
	public String getOfficeGovtNameN() {
		return officeGovtNameN;
	}
	public void setOfficeGovtNameN(String officeGovtNameN) {
		this.officeGovtNameN = officeGovtNameN;
	}
	public String getGovtCountryNameN() {
		return govtCountryNameN;
	}
	public void setGovtCountryNameN(String govtCountryNameN) {
		this.govtCountryNameN = govtCountryNameN;
	}
	public String getGovtStateNameN() {
		return govtStateNameN;
	}
	public void setGovtStateNameN(String govtStateNameN) {
		this.govtStateNameN = govtStateNameN;
	}
	public String getGovtDistrictNameN() {
		return govtDistrictNameN;
	}
	public void setGovtDistrictNameN(String govtDistrictNameN) {
		this.govtDistrictNameN = govtDistrictNameN;
	}
	public String getGovtAdressN() {
		return govtAdressN;
	}
	public void setGovtAdressN(String govtAdressN) {
		this.govtAdressN = govtAdressN;
	}
	public String getGovtNoOfPersonN() {
		return govtNoOfPersonN;
	}
	public void setGovtNoOfPersonN(String govtNoOfPersonN) {
		this.govtNoOfPersonN = govtNoOfPersonN;
	}
	public String getGovtCountryName() {
		return govtCountryName;
	}
	public void setGovtCountryName(String govtCountryName) {
		this.govtCountryName = govtCountryName;
	}
	public String getGovtStateName() {
		return govtStateName;
	}
	public void setGovtStateName(String govtStateName) {
		this.govtStateName = govtStateName;
	}
	public String getGovtDistrictName() {
		return govtDistrictName;
	}
	public void setGovtDistrictName(String govtDistrictName) {
		this.govtDistrictName = govtDistrictName;
	}
	public String getGovtAdress() {
		return govtAdress;
	}
	public void setGovtAdress(String govtAdress) {
		this.govtAdress = govtAdress;
	}
	public String getGovtNoOfPerson() {
		return govtNoOfPerson;
	}
	public void setGovtNoOfPerson(String govtNoOfPerson) {
		this.govtNoOfPerson = govtNoOfPerson;
	}

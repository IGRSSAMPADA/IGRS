package com.wipro.igrs.estamping.bo;
...
public class EstampBO {
	 ...
	 */
	/*
	 * public ArrayList getCountry() throws Exception { return
	 * objDao.getCountry(); }
	 */
	/**
		...
		if (list != null && list.size() > 0) {
			...
			try {
				for (int i = 0; i < list.size(); i++) {
					...
					/*
					 * if(rowList.get(2)!=null){ int
					 * paidAmt=Integer.parseInt(rowList.get(2).toString()); int
					 * balAmt=Integer.parseInt(rowList.get(6).toString());
					 * if(balAmt>=paidAmt){ objDashBoardDTO.setBalanceAmount(0);
					 * } }
					 */
			...
			if ("E".equalsIgnoreCase(type)) {
				...
				try {
					if (list != null && list.size() > 0) {
						...
						// try{
						for (int i = 0; i < list.size(); i++) {
							// DashBoardDTO objDashBoardDTO = new
							// DashBoardDTO();
							rowList = (ArrayList) list.get(i);
							// objDashBoardDTO = new DashBoardDTO();
							// if(rowList.get(0).toString().length()==11){
							...
							/*
							 * if
							 * (objDashBoardDTO.getEstampStatus().toString().equals
							 * ("A")) objDashBoardDTO.setEstampStatus("Active");
							 * 
							 * else if
							 * (objDashBoardDTO.getEstampStatus().toString
							 * ().equals("E"))
							 * objDashBoardDTO.setEstampStatus("Expired"); else
							 * objDashBoardDTO.setEstampStatus("Deactive");
							 */
							...
							/*
							 * if(lang.equalsIgnoreCase("en")){
							 * objDashBoardDTO.setDistrictname
							 * (rowList.get(9).toString()); }else{
							 * objDashBoardDTO
							 * .setDistrictname(rowList.get(10).toString()); }
							 */
				...
				try {
					if (list != null && list.size() > 0) {
						...
						for (int i = 0; i < list.size(); i++) {
							 ...
							 * } if(lang.equalsIgnoreCase("en")){
							 * objDashBoardDTO
							 * .setDistrictname(rowList.get(9).toString());
							 * }else{
							 * objDashBoardDTO.setDistrictname(rowList.get
							 * (10).toString()); }
							 */
							ecodeDetails.add(objDashBoardDTO);
						}
	...
	public ArrayList viewEcodeDetailsDRS(String ecode, String lang) throws Exception {
		...
		/* Added by Gulrej adds Refund Request no in View Screen End *///---added
																		// by
																		// satbir
																		// kumar
																		// ---
			...
			if (list != null && list.size() > 0) {
				...
				try {
					for (int i = 0; i < list.size(); i++) {
						 ...
						 * objDashBoardDTO.setEstampStatus("Expired");
						 * 
						 * else objDashBoardDTO.setEstampStatus("Deactive");
						 */
						objDashBoardDTO.setEstampValidity(rowList.get(4));
						String buyername = (String) (rowList.get(5));
						 ...
						 * objDashBoardDTO.setRegInitId("-"); } else {
	...
	public ArrayList getDetailsOfApplicantDRS(String ecode, String language) throws Exception {
		...
		String txnid = "";
		String type = objEstampingBD.getecodetype(ecode); // ---added by satbir
															// kumar---
		// if("E".equalsIgnoreCase(type)||"C".equalsIgnoreCase(type)||"R".
		...
		if ("E".equalsIgnoreCase(type)) {
					...
					for (int i = 0; i < list.size(); i++) {
						...
						if (objDashBoardDTO.getApplicant_ind().toString().equalsIgnoreCase("Y")) {
							...
							// }else{
							{
								...
								// ArrayList list6 =
								// objEstampingBD.getorgDetailsOfApplicantDRS
								// (ecode);
								objDashBoardDTO.setAppType(rowList.get(2));
								objDashBoardDTO.setAppTypeName(rowList.get(1));
			...
			String regID = objEstampingBD.getregId(ecode);
			// ArrayList list = objEstampingBD.getCRtype(regID); //----giving
			// applicant type and apptype----
			ArrayList list = objEstampingBD.getCRYDetailsOfApplicantDRS(regID, language);
			// ArrayList
			// list=objEstampingBD.getCRDetailsOfApplicantDRS(ecode,regID);
			DashBoardDTO objDashBoardDTO = new DashBoardDTO();
			if (list != null && list.size() > 0) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					if (objDashBoardDTO.getApplicant_ind().toString().equalsIgnoreCase("Y")) {
						...
						else if (objDashBoardDTO.getAppType().toString().equals("3")) {
							ArrayList detailsNindv = objEstampingBD.getCRYindvDetailsOfGOVApplicantDRS(regID, language);
							if (detailsNindv != null && detailsNindv.size() > 0) {
								ArrayList rowList4 = new ArrayList();
								for (int s = 0; s < detailsNindv.size(); s++) {
									rowList4 = (ArrayList) detailsNindv.get(s);
									objDashBoardDTO.setAppType(rowList4.get(2));
									objDashBoardDTO.setAppTypeName(rowList4.get(1));
									objDashBoardDTO.setNameOfOfficial((String) rowList4.get(23));
									objDashBoardDTO.setDesignationOfOfficial((String) rowList4.get(24));
									objDashBoardDTO.setOfficeGovtName((String) rowList4.get(25));
									objDashBoardDTO.setGovtCountryName((String) rowList4.get(10));
									objDashBoardDTO.setGovtStateName((String) rowList4.get(11));
									objDashBoardDTO.setGovtDistrictName((String) rowList4.get(12));
									objDashBoardDTO.setGovtAdress((String) rowList4.get(26));
									objDashBoardDTO.setGovtNoOfPerson((String) rowList4.get(19));
								}
							}
						} else {
							objDashBoardDTO.setAppType(rowList1.get(2));
			...
			if (list1 != null && list1.size() > 0) {
				...
				for (int j = 0; j < list1.size(); j++) {
					...
					if (app.equalsIgnoreCase("N")) {
						...
						// }else{
						{
						...
						else if (objDashBoardDTO.getPartyType().toString().equals("3")) {
							ArrayList detailsNindv = objEstampingBD.getCRNindvDetailsOfGOVApplicantDRS(regID, language);
							if (detailsNindv != null && detailsNindv.size() > 0) {
								ArrayList rowList4 = new ArrayList();
								for (int s = 0; s < detailsNindv.size(); s++) {
									rowList4 = (ArrayList) detailsNindv.get(s);
									objDashBoardDTO.setPartyType(rowList4.get(2));
									objDashBoardDTO.setPartyTypeName(rowList4.get(1));
									objDashBoardDTO.setNameOfOfficialN((String) rowList4.get(23));
									objDashBoardDTO.setDesignationOfOfficialN((String) rowList4.get(24));
									objDashBoardDTO.setOfficeGovtNameN((String) rowList4.get(25));
									objDashBoardDTO.setGovtCountryNameN((String) rowList4.get(10));
									objDashBoardDTO.setGovtStateNameN((String) rowList4.get(11));
									objDashBoardDTO.setGovtDistrictNameN((String) rowList4.get(12));
									objDashBoardDTO.setGovtAdressN((String) rowList4.get(26));
									objDashBoardDTO.setGovtNoOfPersonN((String) rowList4.get(19));
								}
							}
						} else {
							...
							if (detailsNorg != null && detailsNorg.size() > 0) {
								...
								for (int s = 0; s < detailsNorg.size(); s++) {
									...
									// objDashBoardDTO.setPartyAuthMiddleName(
									// rowList2.get(4));
									// objDashBoardDTO.setPartyAuthLastName(
									// rowList2.get(5));
	...
	public ArrayList deactEcodeDetails(String ecode, DashBoardDTO dto, String lang) throws Exception {
		...
		try {
			...
			String type = objEstampingBD.getecodetype(ecode); // ---added by
																// satbir
																// kumar---
			if ("E".equalsIgnoreCase(type)) {
		...
		if (list != null && list.size() > 0) {
			...
			try {
				for (int i = 0; i < list.size(); i++) {
					...
					//objEstampDetailsDTO.setLastTransactionDate(rowList.get(4).
					// toString());
					if ((rowList.get(4)) == null)
	...
	public String getCurrentDate() throws Exception {
		...
		/*
		 * DateFormat formatter= new SimpleDateFormat("mm/dd/yyyy hh:mm:ss");
		 * Date date = (Date)formatter.parse(currDate); SimpleDateFormat
		 * formatYear = new SimpleDateFormat("yyyy"); String currentYear =

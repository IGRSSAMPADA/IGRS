 ...
 */
public class SPUploadAction extends BaseAction {
	/*
	 * Generated Methods
	 */
	...
	private Logger logger = 
		(Logger) Logger.getLogger(SPUploadAction.class);
		...
		if (uploadForm.getAttachAction().equalsIgnoreCase("attach")) {
			...
			if (session.getAttribute("attachment1") == null) {
				...
				if (rule.isError()) {
					...
					return mapping.findForward("spUpload");
			...
			return (mapping.findForward("spClose"));
		}// end 

...
import com.wipro.igrs.newreginit.clrPojo.KhasraOwnerDetails;
...
public class RegCompletDTO implements Serializable{
	...
	private String mpcstUrl;
	
	private byte[] file1PathContents;
	private byte[] file2PathContents;
	private String file1Path;
	private String file2Path;
	private String hash1;
	private String hash2;
	private String mpcstSuccessFlag;
	
	private FormFile mpcst1 = null;
	private String mpcst1DocumentName;
	private String mpcst1DocumentSize;
	private byte[] mpcst1DocContents;
	private String mpcst1FilePath;
	
	private FormFile mpcst2 = null;
	private String mpcst2DocumentName;
	private String mpcst2DocumentSize;
	private byte[] mpcst2DocContents;
	private String mpcst2FilePath;
	...
	public FormFile getMpcst1() {
		return mpcst1;
	}
	public void setMpcst1(FormFile mpcst1) {
		this.mpcst1 = mpcst1;
	}
	public String getMpcst1DocumentName() {
		return mpcst1DocumentName;
	}
	public void setMpcst1DocumentName(String mpcst1DocumentName) {
		this.mpcst1DocumentName = mpcst1DocumentName;
	}
	public String getMpcst1DocumentSize() {
		return mpcst1DocumentSize;
	}
	public void setMpcst1DocumentSize(String mpcst1DocumentSize) {
		this.mpcst1DocumentSize = mpcst1DocumentSize;
	}
	public byte[] getMpcst1DocContents() {
		return mpcst1DocContents;
	}
	public void setMpcst1DocContents(byte[] mpcst1DocContents) {
		this.mpcst1DocContents = mpcst1DocContents;
	}
	public String getMpcst1FilePath() {
		return mpcst1FilePath;
	}
	public void setMpcst1FilePath(String mpcst1FilePath) {
		this.mpcst1FilePath = mpcst1FilePath;
	}
	public FormFile getMpcst2() {
		return mpcst2;
	}
	public void setMpcst2(FormFile mpcst2) {
		this.mpcst2 = mpcst2;
	}
	public String getMpcst2DocumentName() {
		return mpcst2DocumentName;
	}
	public void setMpcst2DocumentName(String mpcst2DocumentName) {
		this.mpcst2DocumentName = mpcst2DocumentName;
	}
	public String getMpcst2DocumentSize() {
		return mpcst2DocumentSize;
	}
	public void setMpcst2DocumentSize(String mpcst2DocumentSize) {
		this.mpcst2DocumentSize = mpcst2DocumentSize;
	}
	public byte[] getMpcst2DocContents() {
		return mpcst2DocContents;
	}
	public void setMpcst2DocContents(byte[] mpcst2DocContents) {
		this.mpcst2DocContents = mpcst2DocContents;
	}
	public String getMpcst2FilePath() {
		return mpcst2FilePath;
	}
	public void setMpcst2FilePath(String mpcst2FilePath) {
		this.mpcst2FilePath = mpcst2FilePath;
	}
	public byte[] getFile1PathContents() {
		return file1PathContents;
	}
	public void setFile1PathContents(byte[] file1PathContents) {
		this.file1PathContents = file1PathContents;
	}
	public byte[] getFile2PathContents() {
		return file2PathContents;
	}
	public void setFile2PathContents(byte[] file2PathContents) {
		this.file2PathContents = file2PathContents;
	}
	...
	public String getMpcstSuccessFlag() {
		return mpcstSuccessFlag;
	}
	public void setMpcstSuccessFlag(String mpcstSuccessFlag) {
		this.mpcstSuccessFlag = mpcstSuccessFlag;
	}
	public String getMpcstUrl() {
		return mpcstUrl;
	}
	public void setMpcstUrl(String mpcstUrl) {
		this.mpcstUrl = mpcstUrl;
	}
	...
	private String multiPropsFromAgri;
	
	
	
	
	public String getMultiPropsFromAgri() {
		return multiPropsFromAgri;
	}
	public void setMultiPropsFromAgri(String multiPropsFromAgri) {
		this.multiPropsFromAgri = multiPropsFromAgri;
	}
  ...
  //following added by roopam for compliance list
	...
	private FormFile auditReport = null;
	private String auditReportDocumentName;
	private String auditReportDocumentSize;
	private byte[] auditReportDocContents;
	private String auditReportFilePath;
	private String auditReportPartyOrProp;
	private String auditReportUploadType;
	
	
	
	//added by Shreeraj
	private String checkboxProperty;
	private String checkboxParticular;
	...
	public String getCheckboxParticular() {
		return checkboxParticular;
	}
	public void setCheckboxParticular(String checkboxParticular) {
		this.checkboxParticular = checkboxParticular;
	}
	...
	public String getAuditReportDocumentName() {
		return auditReportDocumentName;
	}
	public void setAuditReportDocumentName(String auditReportDocumentName) {
		this.auditReportDocumentName = auditReportDocumentName;
	}
	public String getAuditReportDocumentSize() {
		return auditReportDocumentSize;
	}
	public void setAuditReportDocumentSize(String auditReportDocumentSize) {
		this.auditReportDocumentSize = auditReportDocumentSize;
	}
	public byte[] getAuditReportDocContents() {
		return auditReportDocContents;
	}
	public void setAuditReportDocContents(byte[] auditReportDocContents) {
		this.auditReportDocContents = auditReportDocContents;
	}
	public String getAuditReportFilePath() {
		return auditReportFilePath;
	}
	public void setAuditReportFilePath(String auditReportFilePath) {
		this.auditReportFilePath = auditReportFilePath;
	}
	public String getAuditReportPartyOrProp() {
		return auditReportPartyOrProp;
	}
	public void setAuditReportPartyOrProp(String auditReportPartyOrProp) {
		this.auditReportPartyOrProp = auditReportPartyOrProp;
	}
	public String getAuditReportUploadType() {
		return auditReportUploadType;
	}
	public void setAuditReportUploadType(String auditReportUploadType) {
		this.auditReportUploadType = auditReportUploadType;
	}
...
/*	public String getPropUsageTypeId() {
	...
	private String northKhasraNo;
	private String southKhasraNo;
	private String eastKhasraNo;
	private String westKhasraNo;
	private String partyDetails;
	private String riCircle;
	private String casteOfParty;
	private String shareOfParty;
	private String mortOfParty;
	...
	public String getMortOfParty() {
		return mortOfParty;
	}
	public void setMortOfParty(String mortOfParty) {
		this.mortOfParty = mortOfParty;
	}

	private ArrayList<KhasraOwnerDetails> ownerDtls=new ArrayList<KhasraOwnerDetails>();
	private String mapPathClr;
	private String khasraPathClr;
	private byte[] khasraPdfContents;
	private byte[] MapPdfContents;
	private FormFile mapPathFF;
	private FormFile khasraPathFF;
	private String clrkhasraNo;
	private String clrKhasraArea;
	...
	public FormFile getMapPathFF() {
		return mapPathFF;
	}
	public void setMapPathFF(FormFile mapPathFF) {
		this.mapPathFF = mapPathFF;
	}
	public FormFile getKhasraPathFF() {
		return khasraPathFF;
	}
	public void setKhasraPathFF(FormFile khasraPathFF) {
		this.khasraPathFF = khasraPathFF;
	}
	...
	public String getClrkhasraNo() {
		return clrkhasraNo;
	}
	public void setClrkhasraNo(String clrkhasraNo) {
		this.clrkhasraNo = clrkhasraNo;
	}
	public String getClrKhasraArea() {
		return clrKhasraArea;
	}
	public void setClrKhasraArea(String clrKhasraArea) {
		this.clrKhasraArea = clrKhasraArea;
	}
	public String getNorthKhasraNo() {
		return northKhasraNo;
	}
	public void setNorthKhasraNo(String northKhasraNo) {
		this.northKhasraNo = northKhasraNo;
	}
	public String getSouthKhasraNo() {
		return southKhasraNo;
	}
	public void setSouthKhasraNo(String southKhasraNo) {
		this.southKhasraNo = southKhasraNo;
	}
	public String getEastKhasraNo() {
		return eastKhasraNo;
	}
	public void setEastKhasraNo(String eastKhasraNo) {
		this.eastKhasraNo = eastKhasraNo;
	}
	public String getWestKhasraNo() {
		return westKhasraNo;
	}
	public void setWestKhasraNo(String westKhasraNo) {
		this.westKhasraNo = westKhasraNo;
	}
	...
	public ArrayList<KhasraOwnerDetails> getOwnerDtls() {
		return ownerDtls;
	}
	public void setOwnerDtls(ArrayList<KhasraOwnerDetails> ownerDtls) {
	...
	public byte[] getKhasraPdfContents() {
		return khasraPdfContents;
	}
	public void setKhasraPdfContents(byte[] khasraPdfContents) {
		this.khasraPdfContents = khasraPdfContents;
	}
	public byte[] getMapPdfContents() {
		return MapPdfContents;
	}
	public void setMapPdfContents(byte[] mapPdfContents) {
		MapPdfContents = mapPdfContents;
	}
	...
	//private <RegCompletDTO> clrOwnerArray;
	...
	public void setKhasraSellableArea(String khasraSellableArea) {
		this.khasraSellableArea = khasraSellableArea;
	}
	
	// Added by rakesh for user computerised khasra 
	
	private FormFile propertyKhasraClr = null;
	private String propKhasraDocumentNameClr;
	private String propKhasraDocumentSizeClr;
	private byte[] propKhasraDocContentsClr;
	private String propKhasraFilePathClr;
	private String propKhasraPartyOrPropClr;
	private String propKhasraUploadTypeClr;




	
	public FormFile getPropertyKhasraClr() {
		return propertyKhasraClr;
	}
	public void setPropertyKhasraClr(FormFile propertyKhasraClr) {
		this.propertyKhasraClr = propertyKhasraClr;
	}
	public String getPropKhasraDocumentNameClr() {
		return propKhasraDocumentNameClr;
	}
	public void setPropKhasraDocumentNameClr(String propKhasraDocumentNameClr) {
		this.propKhasraDocumentNameClr = propKhasraDocumentNameClr;
	}
	public String getPropKhasraDocumentSizeClr() {
		return propKhasraDocumentSizeClr;
	}
	public void setPropKhasraDocumentSizeClr(String propKhasraDocumentSizeClr) {
		this.propKhasraDocumentSizeClr = propKhasraDocumentSizeClr;
	}
	public byte[] getPropKhasraDocContentsClr() {
		return propKhasraDocContentsClr;
	}
	public void setPropKhasraDocContentsClr(byte[] propKhasraDocContentsClr) {
		this.propKhasraDocContentsClr = propKhasraDocContentsClr;
	}
	public String getPropKhasraFilePathClr() {
		return propKhasraFilePathClr;
	}
	public void setPropKhasraFilePathClr(String propKhasraFilePathClr) {
		this.propKhasraFilePathClr = propKhasraFilePathClr;
	}
	public String getPropKhasraPartyOrPropClr() {
		return propKhasraPartyOrPropClr;
	}
	public void setPropKhasraPartyOrPropClr(String propKhasraPartyOrPropClr) {
		this.propKhasraPartyOrPropClr = propKhasraPartyOrPropClr;
	}
	public String getPropKhasraUploadTypeClr() {
		return propKhasraUploadTypeClr;
	}
	public void setPropKhasraUploadTypeClr(String propKhasraUploadTypeClr) {
		this.propKhasraUploadTypeClr = propKhasraUploadTypeClr;
	}
	...
	private String khasraNumbClrNonEdit;
	private String khasraAreaClrNonEdit;




	public String getKhasraNumbClrNonEdit() {
		return khasraNumbClrNonEdit;
	}
	public void setKhasraNumbClrNonEdit(String khasraNumbClrNonEdit) {
		this.khasraNumbClrNonEdit = khasraNumbClrNonEdit;
	}
	public String getKhasraAreaClrNonEdit() {
		return khasraAreaClrNonEdit;
	}
	public void setKhasraAreaClrNonEdit(String khasraAreaClrNonEdit) {
		this.khasraAreaClrNonEdit = khasraAreaClrNonEdit;
	}
	
		
	//added by ankit for GIS work
	private String gisReferenceKey;
	private String gisFlag;
	private String munGISFlag;

	public String getGisReferenceKey() {
		return gisReferenceKey;
	}
	public void setGisReferenceKey(String gisReferenceKey) {
		this.gisReferenceKey = gisReferenceKey;
	}
	...
	public String getMunGISFlag() {
		return munGISFlag;
	}
	public void setMunGISFlag(String munGISFlag) {
		this.munGISFlag = munGISFlag;
	}

package com.wipro.igrs.commonEfiling.bo;

import java.util.ArrayList;
import org.apache.log4j.Logger;
import java.math.BigDecimal;
import com.wipro.igrs.commonEfiling.dao.CommonDAO;
...
public class CommonBO {
	...
	public CommonDTO getplotPropertyDetails(String language, String id) {
		...
		logger.debug("com.wipro.igrs.commonEfiling.bo.CommonBO :: getplotPropertyDetails() :: Start");
		...
		try{
			...
			if(propertyDetails!=null&& propertyDetails.size()>0)
			{
				...
				for(int i=0;i<propertyDetails.size();i++)
				{
					...
					logger.debug("com.wipro.igrs.commonEfiling.bo.CommonBO :: getplotPropertyDetails() :: End");

    ...
    */
    ...
    public static synchronized OracleDataSource getConnectionPool() throws Exception {
	    ...
	    try
	    {
            ...
            logger.debug("DB Name:-"+pr.getValue("DB_NAME")); 
            logger.debug("User ID:-"+pr.getValue("DB_USER_ID"));
            logger.debug("Server Type:-"+pr.getValue("SERVER_TYPE"));
   ...
   /* public static DataSource getDataSource() throws Exception {
    ...
    public static DataSource getDataSourcePool() throws Exception {
        try {
           ...
           // if (ds == null) {
                logger.debug("in getDataSourcePool() method.");
               ...
               // context = new InitialContext();    
                ...
                logger.debug("TTTTTTCame here in DataSourceLookUp.getDataSource()with DataSource = " + ds);
           // }
        } catch (NamingException e) {
        	logger.debug(e);
        }

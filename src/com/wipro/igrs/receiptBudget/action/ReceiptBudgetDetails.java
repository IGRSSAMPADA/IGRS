...
public class ReceiptBudgetDetails extends BaseAction
{
	private  Logger logger = 
		(Logger) Logger.getLogger(ReceiptBudgetDetails.class);
								...
								HttpServletResponse response,HttpSession session)
	{
		...
		ReceiptBudgetForm budget = (ReceiptBudgetForm)form;
		BudgetBD bd = null;
	...
	//	HttpSession session1 = request.getSession();
		...
		//request.setAttribute("budget2", budget2);

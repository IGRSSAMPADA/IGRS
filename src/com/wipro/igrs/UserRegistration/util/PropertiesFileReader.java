...
public class PropertiesFileReader {
     ...
     * Description	:  Class constructor to initialize the ResourceBundle for
     *  the database.properties file
     * @throws  Exception
     */
    public static synchronized PropertiesFileReader getInstance(String
    ...
    /**
     * Method 		:	getValue
     * Description	:	This method is used to get the value of the specified key
    ...
    /*
     * Method 		:	getKeys
     * Description	:	This method is used to get the list of keys available in
     *  the database.properties file
    ...
    public static void main(String[] a ){
           try {
                      PropertiesFileReader pr=PropertiesFileReader.getInstance
	                      ();
                      System.out.println(pr.getValue("PROVIDER_URL"));
           }catch(Exception x){

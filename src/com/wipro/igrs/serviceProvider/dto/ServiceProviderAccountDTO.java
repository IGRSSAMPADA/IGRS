 ...
 * 
 */
public class ServiceProviderAccountDTO implements Serializable{
	/**
	 * 
	 */
	...
	private String radioButton;//Added by Aakash
	//START | Added by santosh as part of ledger view changes
	private String judLedgerViewSearchMsg;
	private String ledgerViewSearchMsg;
	public String getJudLedgerViewSearchMsg() {
		return judLedgerViewSearchMsg;
	}

	public void setJudLedgerViewSearchMsg(String judLedgerViewSearchMsg) {
		this.judLedgerViewSearchMsg = judLedgerViewSearchMsg;
	}

	public String getLedgerViewSearchMsg() {
		return ledgerViewSearchMsg;
	}

	public void setLedgerViewSearchMsg(String ledgerViewSearchMsg) {
		this.ledgerViewSearchMsg = ledgerViewSearchMsg;
	}
	//END | Added by santosh as part of ledger view changes
	...
	public String toString() {
		return "toDate:" + todate + ",fromDate:" + fromdate + ",txnId:" + txnid
				+ ",CRN/EPRN:" + crn + ",Payment Amount:" + payamount;
	}

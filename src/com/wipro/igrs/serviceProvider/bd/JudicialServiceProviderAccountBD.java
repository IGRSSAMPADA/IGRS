/**
 * JudicialServiceProviderAccountBD.java
...
import com.wipro.igrs.serviceProvider.dao.JudicialServiceProviderAccountDAO;
 ...
 * 
 */
public class JudicialServiceProviderAccountBD {
	
	private static Logger logger = 
		(Logger) Logger.getLogger(JudicialServiceProviderAccountBD.class);

	/**
	 * Constructor name : ServiceProviderAccountBD
	 * 
	 */
	JudicialServiceProviderAccountDAO jServiceProviderDAO = null;
	 ...
	 * @throws Exception
	 */
	public JudicialServiceProviderAccountBD() throws Exception {
		jServiceProviderDAO = new JudicialServiceProviderAccountDAO();
	}
	...
	/*public String getUserType(String userid) throws Exception {
		...
		ArrayList arrayList = jServiceProviderDAO.getUserType(userid);
	...
	/*public ArrayList getServiceProviderInfo(String userid) throws Exception {
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getServiceProviderInfo(userid);
	...
	*/
	...
	/*public ArrayList getSpAcntDetails(String userid,String sessionLicenseNo) throws Exception {
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getSpAcntDetails(userid,sessionLicenseNo);
			if(arrayList.size()==0)
			{
				ArrayList arrayList1 = new ArrayList();
				//ServiceProviderAccountDAO serviceProviderDAO1 = new ServiceProviderAccountDAO();
				arrayList1=jServiceProviderDAO.getSpDetails(userid);
				...
				if(arrayList1.size()==0)
				{
					...
					arrayList1 = jServiceProviderDAO.getSpBankDetails(userid);
				}
	...
	public ArrayList getSpAcntDetailsEstamp(String userid,String sessionLicenseNo) throws Exception {
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getSpAcntDetailsEstamp(userid,sessionLicenseNo);
			if(arrayList.size()==0)
			{
				ArrayList arrayList1 = new ArrayList();
				//ServiceProviderAccountDAO serviceProviderDAO1 = new ServiceProviderAccountDAO();
	...
	/*public ArrayList getServiceProviderStmt(String sessionLicenseNo,
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getServiceProviderStmt(sessionLicenseNo, accountDTO,language);
			logger.info("arraylist" + arrayList);
			providerinfolist = new ArrayList();
			ServiceProviderAccountDTO providerDTO = null;
			if(arrayList.size()==0)
	...
	public ArrayList getServiceProviderStmtEstamp(String sessionLicenseNo,
			ServiceProviderAccountDTO accountDTO, String language,
			HttpSession session) throws Exception {
		// End Validate user id based on license number
		ArrayList providerinfolist = null;
		try {
			// ServiceProviderAccountDAO serviceProviderDAO = new
			// ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO
					.getServiceProviderStmtEstamp(sessionLicenseNo, accountDTO,
							language, session);
			logger.info("arraylist" + arrayList);
			providerinfolist = new ArrayList();
			ServiceProviderAccountDTO providerDTO = null;
	...
	/*public ArrayList getServiceProviderStmtonMonth(String userid,
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getServiceProviderStmtmonth(userid, accountDTO);
			logger.info("arraylist" + arrayList);
			providerinfolist = new ArrayList();
			ServiceProviderAccountDTO providerDTO = null;
			for (int i = 0; i < arrayList.size(); i++) {
	...
	/*public ArrayList getServiceProviderBankInfo(String userid) throws Exception {
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getServiceProviderBankInfo(userid);
			logger.info("arraylist" + arrayList);
			providerinfolist = new ArrayList();
			ServiceProviderAccountDTO providerDTO = null;
			for (int i = 0; i < arrayList.size(); i++) {
	...
	/*public boolean spAcntBalUpdt(ServiceProviderAccountDTO accountDTO,String userid) throws Exception {
			...
			return jServiceProviderDAO.spAcntBalUpdt(accountDTO, userid);
	...
	public boolean spAcntBalUpdtEstamp(ServiceProviderAccountDTO accountDTO,String userid) throws Exception {
		...
		return jServiceProviderDAO.spAcntBalUpdtEstamp(accountDTO, userid);
	...
	/*public boolean spDebitAcntBalUpdt(ServiceProviderAccountDTO accountDTO,String userid) throws Exception {
		...
		return jServiceProviderDAO.spDebitAcntBalUpdt(accountDTO, userid);
	...
	/*public ArrayList spCreditBalance(String userid) throws Exception
	{
		...
		try{
			...
			JudicialServiceProviderAccountBD bd=new JudicialServiceProviderAccountBD();
			String lno=bd.getLicenseNumber(userid);
			
		ArrayList list=jServiceProviderDAO.spCreditBalance(lno);
	...
	/*public boolean getSPBalanceAfterDebit(String userid,String status,String paymode,String amount) {	
		...
		String amnt=amount;
				...
				JudicialServiceProviderAccountBD providerBD = new JudicialServiceProviderAccountBD();
				...
				if(funId=="FUN_023")
				{
				String commFac=jServiceProviderDAO.getSpCommFactor();
...
*/		//}
	...
	public String getLicenseNumber(String userid) throws Exception {
		String licenseno = "";
		//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
		ArrayList arrayList = jServiceProviderDAO.getLicenseNumber(userid);
   ...
   /* public String getSPCommission(String _funId,String _amt) throws Exception
    { 	
    //ServiceProviderAccountDAO serviceProviderDAO =new ServiceProviderAccountDAO();
    return jServiceProviderDAO.getSPComm(_funId, _amt);
	}*/
    //end
    /*public String getOpeningBal(String sessionLicenseNo) throws Exception
    {
    	//ServiceProviderAccountDAO serviceProviderDAO =new ServiceProviderAccountDAO();
    	return jServiceProviderDAO.getOpeningBal(sessionLicenseNo);
    }*/
    ...
    {
    	//ServiceProviderAccountDAO serviceProviderDAO =new ServiceProviderAccountDAO();
    	return jServiceProviderDAO.getOpeningBalEstamp(sessionLicenseNo);
    }*/
    
    //added by Lavi for getting the office id and district id of DR for integration with new payment module.
    ...
    public ServiceProviderAccountForm getOfficeId(ServiceProviderAccountForm providerAccountForm) throws Exception {
		...
		try {
			//ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
			ArrayList arrayList = jServiceProviderDAO.getOfficeId(providerAccountForm);
			logger.info("arraylist" + arrayList);
 ...
 // START | changes to fetch credit limit param value by santosh
    ...
    public String getJudLedgerParam() throws Exception {
		...
		judLedgerParam = jServiceProviderDAO.getJudLedgerParam();
 ...
 // END | changes to fetch credit limit param value by santosh
    ...
    /*public String getLicenseId(String userid) throws Exception {
       // ServiceProviderAccountDAO serviceProviderDAO = new ServiceProviderAccountDAO();
        return jServiceProviderDAO.getLicenseId(userid);
  }*/

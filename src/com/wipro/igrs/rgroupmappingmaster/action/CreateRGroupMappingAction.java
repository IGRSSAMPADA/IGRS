...
public class CreateRGroupMappingAction extends BaseAction{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		ArrayList rGroupmappingList = rGroupmappingBD.getRgroupmappingList();
		...
		//System.out.println("###"+rGroupmappingForm.getRolegroupId());
		
		try
		{
			
			rGroupmappingBD.addRgroupmappingmaster(rGroupmappingForm, roleId, funId, userId);
		}

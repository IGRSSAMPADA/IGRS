			...
			if(guideLineValuesList!=null && guideLineValuesList.size()>0)
			{
				for (int i = 0; i < guideLineValuesList.size(); i++)
				{
					...
					if(i==2)
					{
						...
						DoubleCropRate=Double.parseDouble((String) subList.get(1)); //double crop rate will be same as single crop
					}
					//commented by saurav
					/*if(i==3)
					{
		...
		public String[] calcDiverted(PropertyValuationDTO divpropDTO, PropertyValuationDTO propDTO){
            ...
            if(guideLineValuesList!=null && guideLineValuesList.size()>0)
			{
				for (int i = 0; i < guideLineValuesList.size(); i++)
				{
					...
					{
						OneCropRate=Double.parseDouble((String) subList.get(1));
						DoubleCropRate=Double.parseDouble((String) subList.get(1)); //double crop rate will be same as single crop rate
					}
					//commented by saurav for change in double crop rate logic
					/*if(i==3)
					{
						DoubleCropRate=Double.parseDouble((String) subList.get(1));
					}*/
	          ...
	          //---null handling of undiverted areas
	            ...
	            if(guideLineValuesList!=null && guideLineValuesList.size()>0)
				{
					for (int i = 0; i < guideLineValuesList.size(); i++)
					{
						...
						{
							OneCropRate=Double.parseDouble((String) subList.get(1));
							DoubleCropRate=Double.parseDouble((String) subList.get(1));//double crop rate will now be as single crop rate
						}
						//commented by saurav for double crop rate change
						/*if(i==3)
						{
							DoubleCropRate=Double.parseDouble((String) subList.get(1));
						}*/

...
public void setFinancialYear(String financialYear) {
	...
	private String docSearchHyperLink;
	public String getDocSearchHyperLink() {
		return docSearchHyperLink;
	}

	public void setDocSearchHyperLink(String docSearchHyperLink) {
		this.docSearchHyperLink = docSearchHyperLink;
	}

...
public class PropertyValuationDTO implements Serializable{
	...
	// Added By aruna
	private String usePlotIDForDisplay;
	/**
	 * @author Madan Mohan
	 */
	...
	public String getUsePlotIDForDisplay() {
		return usePlotIDForDisplay;
	}
	public void setUsePlotIDForDisplay(String usePlotIDForDisplay) {
		this.usePlotIDForDisplay = usePlotIDForDisplay;
	}

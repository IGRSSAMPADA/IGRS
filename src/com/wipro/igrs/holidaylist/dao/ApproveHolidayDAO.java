...
/* 
 * FILE NAME: ApproveHolidayDAO.java
 ...
 *
 */
public class ApproveHolidayDAO {


	private Logger logger = (Logger) Logger.getLogger(ApproveHolidayDAO.class);
	DBUtility dbUtil;
	 ...
	 * @throws Exception
	 */
	public ApproveHolidayDAO() throws Exception{
	...
	public boolean updateHolidayDetails(String[] param) throws Exception {
		...
		try {
			logger.debug("BEFORE ");
			dbUtil.createPreparedStatement(HolidayListSQL.APPROVE_HOLIDAY_DETAILS);
			logger.debug("Query:- "+HolidayListSQL.APPROVE_HOLIDAY_DETAILS);

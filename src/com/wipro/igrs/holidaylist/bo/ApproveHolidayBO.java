...
/* 
 * FILE NAME: ApproveHolidayBO.java
 * @author NIHAR R MISHRA
 * @version 1.0 
 * INITIAL CODING: 8th AUGUST 2008
 * MODIFIED ON:	   None
 * @DESCRIPTION:   THIS CLASS REPRESENTS THE BO FOR HOLIDAY APPROVE.
 */
...
import com.wipro.igrs.holidaylist.dao.ApproveHolidayDAO;
 ...
 *
 */
public class ApproveHolidayBO {

	ApproveHolidayDAO holidayDAO; 

	/**
	 * @throws Exception
	 */
	public ApproveHolidayBO() throws Exception{
		holidayDAO = new ApproveHolidayDAO();
	}
...
/*		param[0] = dto.getHolidayDescription();
		...
		param[2] = dto.getDate();
		param[3] = userId;
		param[4] = dto.getHolidayYear();
*/		param[0] = "A";
		param[1] = userId;
		param[2] = dto.getHolidayId();

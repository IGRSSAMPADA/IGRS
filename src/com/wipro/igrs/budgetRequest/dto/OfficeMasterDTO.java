package com.wipro.igrs.budgetRequest.dto;
...
public class OfficeMasterDTO
{
	private  Logger logger = 
		(Logger) Logger.getLogger(OfficeMasterDTO.class);
	...
	/**
	 * @param subMajorId the subMajorId to set
	 */
	...
	/**
	 * @param subMajorName the subMajorName to set
	 */
	...
	/**
	 * @param list9 the list9 to set
	 */
	public void setList9(ArrayList list9)
	{
		this.list9 = list9;
	}
	/**
	...
	/**
	 * @param list10 the list10 to set
	 */
	public void setList10(ArrayList list10)
	{
		this.list10 = list10;
	}

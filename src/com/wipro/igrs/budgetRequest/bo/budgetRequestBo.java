package com.wipro.igrs.budgetRequest.bo;
...
public class budgetRequestBo
{
	
	public ArrayList getFiscalYear() throws Exception
	{
		BudgetDAO dao = new BudgetDAO();
		return dao.getFiscalYear();
	...
	{
		BudgetDAO dao = new BudgetDAO();
		return dao.budgetCreate(param1);
	}

...
public class CashLinkedBO {
	private Logger logger = (Logger) Logger.getLogger(CashLinkedBO.class);
	public CashLinkedBO() {
	 ...
	 /*  Method Name : getChallanNoDetail()
	   ...
	   public String  getChallanNoDetail(CashCounterForm _paymentForm,int buttonNo)
	    ...
	    *  Exception   : NullPointer or Exception*/
	   public CashCounterForm  getChallanDetail(CashCounterForm _paymentForm) throws NullPointerException ,Exception{

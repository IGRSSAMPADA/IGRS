...
public class CashCounterForm extends ActionForm {

	private CashCounterDTO cashdto = new CashCounterDTO();
	...
	public CashCounterDTO getCashdto() {
		return cashdto;
	}

	public void setCashdto(CashCounterDTO cashdto) {

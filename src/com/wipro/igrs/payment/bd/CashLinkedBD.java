 ...
 * ===========================================================================
 */
public class CashLinkedBD {
	private Logger logger = (Logger) Logger.getLogger(CashLinkedBD.class);
	 public CashLinkedBD() {
	    }
	 ...
	 public ArrayList getPhotoIDList(String languageLocale) throws Exception 
    {
	 ...
	 {
		 CashLinkedDAO dao = new CashLinkedDAO();
      ...
      */
	 public String  getChallanNoDetails(CashCounterLinkedForm _paymentForm,int buttonNo) throws Exception {
	...
	public CashCounterLinkedForm amtCalc(CashCounterLinkedForm form)throws Exception{

		CashCounterBO paymentBO = new CashCounterBO();	
		PhysicalChallanDTO chdtoobj=new PhysicalChallanDTO();
		CashCounterLinkedForm form1=new CashCounterLinkedForm();
	 ...
	 public String getPaymode(String pid)throws Exception{	
		 ...
		 CashLinkedDAO dao4 = new CashLinkedDAO();
	 ...
	 public String getOfficeid(String uid)throws Exception{
			String oid=null;
			CashLinkedDAO dao9 = new CashLinkedDAO();
	 ...
	 public String getempName(String uid)throws Exception{
			String did=null;
			CashLinkedDAO dao10 = new CashLinkedDAO();
	 ...
	 /**
	    ...
	    * 
	    */
	 public CashCounterLinkedDTO getOthersFeeDuty(String _retFunId,String _serId,String _userType)throws Exception{
		 CashCounterLinkedDTO searchDto=new CashCounterLinkedDTO();
	    	try{
	 ...
	 public boolean addCombineDetails(CashCounterLinkedForm form,String uid) throws Exception{
		 CashLinkedDAO dao1 		= new CashLinkedDAO();
	 ...
	 public boolean cashExist(CashCounterLinkedForm form, String userId) throws Exception{
		 CashLinkedDAO dao1 		= new CashLinkedDAO();
		 boolean 	insertflag	= false;
	        String []arry=new String[5];
	          arry[0] = form.getCheckerRegInitId();
	        arry[1]= "A";
	        arry[2]= form.getListService();
	        arry[3] = form.getServFee();
	        arry[4] = userId;
		 insertflag=dao1.getCashExistingDetail(arry);
		 
		 return insertflag;
	 }
	 public boolean cashExistConsumed(CashCounterLinkedForm form, String userId) throws Exception{
		 CashLinkedDAO dao1 		= new CashLinkedDAO();
		 boolean 	insertflag	= false;
	        String []arry=new String[5];
	          arry[0] = form.getCheckerRegInitId();
	 ...
	 public String cashPayableAmt(CashCounterLinkedForm form) throws Exception{
		 CashLinkedDAO dao1 		= new CashLinkedDAO();
		 String 	amt	= "";
	 ...
	 /**
	     ...
	     * return Type  :boolean
	     */
		 public boolean addFinalCashDetails(CashCounterLinkedForm form, HashMap map, String uid)throws Exception{
		 ...
		 /**
			...
			public String getCashReceipt(CashCounterLinkedForm cashform) throws Exception{
				
				 String list1 ;
				
				 //PhysicalChallanDTO chdto=new PhysicalChallanDTO();
				 CashLinkedDAO dao1 = new CashLinkedDAO();
				 list1 =  dao1.getCashReceipt(cashform);
	 ...
	 public boolean addTransidDetails(String tid,String ptid) throws Exception{
		 CashLinkedDAO dao5 = new CashLinkedDAO();
		 boolean insertflag=false;
	 ...
	 public boolean updateStatus(String tid) throws Exception{
		 CashLinkedDAO dao6 = new CashLinkedDAO();
		 boolean insertflag=false;
    ...
    public void commitingTrasanction()throws Exception{
    	CashLinkedDAO dao8 = new CashLinkedDAO();
...
public void cancelTrasanction()throws Exception{
	CashLinkedDAO dao7 = new CashLinkedDAO();
 ...
 */  
 ...
 public ArrayList getData(CashCounterLinkedForm form){
		String status="noData";
		ArrayList finalList = new ArrayList();
		CashLinkedDAO dao;
		
		try {
			dao = new CashLinkedDAO();
...
//akansha
	...
	public String getCombineId(String receipt){
		 String mainlist ="";
		 CashLinkedDAO dao1;
		try {
			dao1 = new CashLinkedDAO();
		
	
		
		 mainlist =  dao1.getCombineId(receipt);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

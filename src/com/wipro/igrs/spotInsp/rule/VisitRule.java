...
// */
//
//package com.wipro.igrs.estamping.rule;
//
//import java.util.ArrayList;
//
//import com.wipro.igrs.util.PropertiesFileReader;
//import com.wipro.igrs.estamping.constant.CommonConstant;
//import com.wipro.igrs.estamping.dao.WillDepositDAO;
//import com.wipro.igrs.estamping.dto.WillDepositDTO;
//import com.wipro.igrs.estamping.form.WillDepositForm;
//
//
...
//            if (CommonConstant.WILL_DEPOSIT_FORM.equalsIgnoreCase(dto.getWillDepositForm())) {
//                if (CommonConstant.WILL_DEPOSIT_INSERT_ACTION.equalsIgnoreCase(dto.getWillDepositInsertAction())) {
//
//
//                    if (dto.getFirstName() == null) {
//                        flag = true;
//                        errorList.add(pr.getValue("error.willdeposit.firstname"));
//                    }
//
//                    /*if (dto.getMidName() == null) {
//                        flag=true;
//                        map.put("willDTO.midName", "error.willdeposit.middlename");
//                    }
//                    if (dto.getLastName() == null) {
//                        flag=true;
//                        map.put("willDTO.lastName", "error.willdeposit.lastname");
//                    }
...
//
//                    if (dto.getAge() == 0) {
//                        //errors.add("willDTO.age", new ActionError("error.willdeposit.testageequalzero"));
//                        flag = true;
//                        errorList.add(pr.getValue("error.willdeposit.testageequalzero"));
//
//                        //map.put("willDTO.age", "error.willdeposit.testageequalzero");
//                    }
//                    /*
//                    if (dto.getFatherName() == null) {
//                        map.put("willDTO.fatherName", "error.willdeposit.fatherName");
//                    }
//
//                    if (dto.getMotherName() == null) {
//                        map.put("willDTO.motherName", "error.willdeposit.motherName");
//                    }
//
...
//                if (lst != null) {
//                    if (lst.size() > 0) {
//                        errorList.add(pr.getValue("error.willdeposit.withdrawalheader") + 
//                                      " " + param[0] + " " + 
//                                      pr.getValue("error.willdeposit.withdrawalfooter"));
//                        flag = true;
//                    }
//                }
//
